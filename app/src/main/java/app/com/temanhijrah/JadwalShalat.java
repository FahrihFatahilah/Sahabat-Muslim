...
import app.com.temanhijrah.Service.NotificationService;
...
public class JadwalShalat extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        new MenuInflater(this).inflate(R.menu.menushlat, menu);
        return true;
    }
    ...
    private void updateFromTheInternet(final boolean refresh) {
        ...
        String url = "http://api.aladhan.com/v1/calendarByCity?city=Jawa%20Barat&country=Indonesia&method=5";
    ...
    private void parseJsonResponseToTheDataBase(String response) {
        try {
            ...
            if (jsonObject.getInt("code") == 200) {
                ...
                Toast.makeText(JadwalShalat.this, "Error Connecting to the server", Toast.LENGTH_SHORT).show();
            }
    ...
    private void ScheduleRepeatingAlarmToFireNotificationServiceEveryDay() {
        ...
        Intent serviceIntent = new Intent(JadwalShalat.this, NotificationService.class);
    ...
    private class VolleyOnResponseAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean refresh) {
            ...
            if (refresh) {
                Toast.makeText(JadwalShalat.this, "Refreshed", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private class VolleyOnErrorAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(JadwalShalat.this, "Error updating prayer timing", Toast.LENGTH_LONG).show();
        }
    }
