...
import app.com.temanhijrah.adapter.RecyclerViewAdapter;
import app.com.temanhijrah.adapter.RecyclerViewAdapterBacaan;
...
public class ActivityAsmaulHusna extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
            mediaPlayer.stop();
            mediaPlayer.reset();
           Intent intent = new Intent(ActivityAsmaulHusna.this,ActivityUtama.class);
